...
public class DetailsActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStartingPosition = getIntent().getIntExtra(TransitionMainActivity.EXTRA_STARTING_ALBUM_POSITION, 0);
    ...
    public void finishAfterTransition() {
        ...
        data.putExtra(TransitionMainActivity.EXTRA_STARTING_ALBUM_POSITION, mStartingPosition);
        data.putExtra(TransitionMainActivity.EXTRA_CURRENT_ALBUM_POSITION, mCurrentPosition);
