package com.example.liyayu.myapplication.transition_demo;
...
import static com.example.liyayu.myapplication.transition_demo.Constants.ALBUM_IMAGE_URLS;
import static com.example.liyayu.myapplication.transition_demo.Constants.ALBUM_NAMES;
...
public class TransitionMainActivity extends Activity {
    ...
    private class CardAdapter extends RecyclerView.Adapter<CardHolder> {
        ...
        public CardAdapter() {
            mInflater = LayoutInflater.from(TransitionMainActivity.this);
        }
    ...
    private class CardHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(int position) {
            Picasso.with(TransitionMainActivity.this).load(ALBUM_IMAGE_URLS[position]).into(mAlbumImage);
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(TransitionMainActivity.this, DetailsActivity.class);
