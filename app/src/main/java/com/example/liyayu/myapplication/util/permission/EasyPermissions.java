...
public class EasyPermissions {
    ...
    public interface PermissionCallbacks extends ActivityCompat.OnRequestPermissionsResultCallback {
        ...
        void onAfterAllPermissionGranted(int requestCode, List<String> perms);
    ...
    public static void requestPermissions(@NonNull Activity activity,
                                          ...
                                          int requestCode,
                                          @NonNull PermissionUtil.Callback callback,
    ...
    public static void requestPermissions(@NonNull Activity activity,
        ...
        if (hasPermissions(activity, perms)) {
            notifyAlreadyHasPermissions(callback, requestCode, perms);
            return;
        }
        if (somePermissionPermanentlyDenied(activity, perms)) {
            notifyPermissionsDenied(callback, requestCode, perms);
            return;
        }
    ...
    public static void onRequestPermissionsResult(int requestCode,
        ...
        for (Object object : receivers) {
            ...
            if (!granted.isEmpty() && denied.isEmpty()) {
                ...
                if (object instanceof PermissionCallbacks) {
                    ((PermissionCallbacks) object).onAfterAllPermissionGranted(requestCode, denied);
                }
            }
        }
    }
    ...
    private static void notifyPermissionsDenied(Object object,
                                                int requestCode,
                                                @NonNull String[] perms) {
        int[] grantResults = new int[perms.length];
        for (int i = 0; i < perms.length; i++) {
